...
//* El # indica que sera una ID

var createdBy = document.querySelector('#createdBy');
createdBy.innerHTML += " Leandro Ariel Frette";
...
function buildToDo(todo, index) {
  ...
  //* <span>descripcion del todo</span> 

  //    5) Asignarle como id del 'toDoText' el valor 'index' recibido como argumento
  toDoText.setAttribute("id", index);
  //* <span id=index recibido por parametro>descripcion del todo</span>
  ...
  //* <span id="someIndex" class="completeText">descripcion del todo</span>
